        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div class="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
            <select
              ...
              class="w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 transition-colors hover:border-gray-300 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 sm:w-auto"
              @change="loadApiKeys()"
            >
            ...
            <!-- 刷新按钮 -->
            <button
              class="btn btn-secondary flex w-full items-center justify-center gap-2 px-4 py-2 text-sm sm:w-auto"
